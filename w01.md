...
1. [Vim Basics in 8 Minutes](https://www.youtube.com/watch?v=ggSyF1SVFr4)<br>
Pertama kali yang saya buka ketika berhasil membuka vim adalah video ini. Ini sangat membantu saya dalam memahami dasar-dasar *command* yang ada di vim. Misalnya
Menyimpan dan quit dari vi
```sh
:wq
```
Mengganti suatu kata dengan kata baru
```sh
:%s/oldword/newword
```
Dikarenakan ke depannya mungkin akan sangat banyak memakai vim, tentu hal ini akan sangat penting dalam menjalani perkuliah Sistem Operasi tahun ini.
