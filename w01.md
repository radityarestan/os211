...
1. [Command Line Crash Course](https://learnpythonthehardway.org/book/appendixa.html)<br>
Dilihat dari namanya, website ini membahas mengenai *command* dasar yang ada pada terminal. Bagi saya yang pemula, website ini sangat membantu dalam mengeskplorasi apa saja yang bisa dilakukan oleh terminal linux, mulai dari mengganti folder, membuat folder, memindahkan file, bagaimana mengembalikan ke home directory ketika tidak tau dimana, dan masih banyak lagi.

2. [Vim Basics in 8 Minutes](https://www.youtube.com/watch?v=ggSyF1SVFr4)<br>
Ini adalah video youtube yang membahas dasar-dasar dalam memakai *command* pada vim. Seperti hal sebelumnya dimana saya adalah pemula, video ini sangat menarik ketika saya kebingungan bagaimana untuk menyimpan pekerjaan, mengganti beberapa kata, dan masih banyak lainnya.
